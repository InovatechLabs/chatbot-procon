...
async function main() {
    ...
    for (const item of cdcData) {
        ...
        await prisma.$executeRawUnsafe(`INSERT INTO "KnowledgeBase" (id, title, content, embedding) VALUES (gen_random_uuid(), $1, $2, $3::vector)`, item.title, item.content, vectorString);
